...
export const careEasyAppPreview = {
  ...
  mobileDescription: '돌봄 기록과 다음 할 일을 한 화면에서 확인합니다.',
  screens: [
    {
      title: '오늘의 돌봄 현황',
      description: '부모님의 일정, 약, 식사, 컨디션을 한 번에 확인합니다.',
      mobileDescription: '일정, 약, 컨디션을 한 번에 확인합니다.',
    ...
    },
    {
      ...
      mobileDescription: '다음 담당자에게 필요한 내용을 전달합니다.',
    ...
    },
    {
      ...
      mobileDescription: '가족이 같은 돌봄 흐름을 확인합니다.',
